                ...
                <div className="p-6">
                    ...
                    >
                        {anime.tags && anime.tags.map((tag, i) => (
                            <span
                                key={i}
                                className="bg-stone-800 text-orange px-2 py-1 rounded text-sm"
                                aria-label={`Tag: ${tag}`}
                            >
                                {tag}
                            </span>
                    ...
                    <button
                        ...
                        className="text-desc px-2 py-1 flex justify-between cursor-pointer w-fit gap-3 rounded bg-secondary"
                    >
                        {!isExpanded ? (
                            <>
                                <p>View More</p>
